...
/** InjectionToken for datetime picker that can be used to override default locale code. */
export const DATETIME_LOCALE = new InjectionToken<string>('DATETIME_LOCALE', {
  providedIn: 'root',
  factory: DATETIME_LOCALE_FACTORY
});

/** @docs-private */
export function DATETIME_LOCALE_FACTORY(): string {
...
export abstract class DatetimeAdapter<T> {
  ...
  protected localeChanges$ = new Subject<void>();
