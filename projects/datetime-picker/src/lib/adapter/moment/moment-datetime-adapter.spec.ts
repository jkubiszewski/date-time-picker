...
import {
  ...
  MOMENT_DATETIME_ADAPTER_OPTIONS
} from './moment-datetime-adapter.class';
import { DatetimeAdapter, DATETIME_LOCALE } from '../datetime-adapter.class';
...
describe('MomentDatetimeAdapter', () => {
  ...
  it("should get today's date", () => {
    expect(adapter.sameDate(adapter.now(), moment())).toBe(true, "should be equal to today's date");
  });
  ...
  it('should throw when attempting to format invalid date', () => {
    expect(() => adapter.format(moment(NaN), 'MM/DD/YYYY')).toThrowError(
      /MomentDatetimeAdapter: Cannot format invalid date\./
    );
  });
  ...
  it('returned Moments should have correct locale', () => {
    ...
    expect(adapter.now().locale()).toBe('ja');
...
describe('MomentDateAdapter with MAT_DATE_LOCALE override', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [MomentDatetimeModule],
      providers: [{ provide: DATETIME_LOCALE, useValue: 'ja-JP' }]
    }).compileComponents();
  }));
...
describe('MomentDateAdapter with MAT_MOMENT_DATE_ADAPTER_OPTIONS override', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: MOMENT_DATETIME_ADAPTER_OPTIONS,
  ...
  describe('use UTC', () => {
    ...
    it('should create today in UTC', () => {
      expect(adapter.now().isUtc()).toBe(true);
    });
