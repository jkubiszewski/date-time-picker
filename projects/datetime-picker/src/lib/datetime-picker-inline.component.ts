...
import { DatetimePickerDirective, PickerMode, PickerType, SelectMode } from './datetime-picker.class';
...
export const DATETIME_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => DatetimePickerInlineComponent),
  multi: true
};

@Component({
  selector: 'ng-datetime-picker-inline',
...
export class DatetimePickerInlineComponent<T> extends DatetimePickerDirective<T>
  implements OnInit, ControlValueAccessor {
  @ViewChild(DatetimePickerContainerComponent, { static: true })
  container: DatetimePickerContainerComponent<T>;
