...
@Component({
  ...
  host: {
    ...
    '[attr.tabindex]': 'dialogContainerTabIndex',
    '[attr.id]': 'dialogContainerId',
    '[attr.role]': 'dialogContainerRole',
    '[attr.aria-labelledby]': 'dialogContainerAriaLabelledby',
    '[attr.aria-describedby]': 'dialogContainerAriaDescribedby',
...
export class DialogContainerComponent extends BasePortalOutlet implements OnInit {
  ...
  get dialogContainerId(): string {
    return this._config.id;
  }

  get dialogContainerRole(): string {
    return this._config.role || null;
  }

  get dialogContainerAriaLabelledby(): string {
    return this.ariaLabelledBy;
  }

  get dialogContainerAriaDescribedby(): string {
    return this._config.ariaDescribedBy || null;
  }

  get dialogContainerAnimation(): any {
