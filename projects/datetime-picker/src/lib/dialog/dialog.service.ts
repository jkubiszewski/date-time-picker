...
export class DialogService {
  ...
  private attachDialogContent<T>(
    ...
    const dialogRef = new DialogRef<T>(overlayRef, dialogContainer, config.id, this.location);
  ...
  private attachDialogContainer(
    ...
    const containerPortal = new ComponentPortal(DialogContainerComponent, config.viewContainerRef);
