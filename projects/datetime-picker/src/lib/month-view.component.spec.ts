...
describe('MonthViewComponent', () => {
  ...
  describe('standard month view', () => {
    ...
    beforeEach(() => {
      ...
      monthViewDebugElement = fixture.debugElement.query(By.directive(MonthViewComponent));
    ...
    it('should have 42 calendar day cells', () => {
      const cellEls = monthViewElement.querySelectorAll('.dtp-calendar-cell')!;
      expect(cellEls.length).toBe(42);
    });

    it('should show selected date if in same month', () => {
      const selectedEl = monthViewElement.querySelector('.dtp-calendar-cell-selected')!;
    ...
    it('should set Sunday as first day of week by default', () => {
      ...
      const weekdayCells = monthViewElement.querySelectorAll('.dtp-weekday');
    ...
    it('should decrement date on left arrow press', () => {
      const calendarBodyEl = monthViewElement.querySelector('.dtp-calendar-body');
