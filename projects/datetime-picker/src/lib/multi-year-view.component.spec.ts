...
describe('MultiYearViewComponent', () => {
  ...
  describe('standard multi-years view', () => {
    ...
    it('should have correct number of years', () => {
      const cellEls = multiYearViewElement.querySelectorAll('.dtp-calendar-cell')!;
    ...
    it('should mark active date', () => {
      ...
      expect(cell2017.classList).toContain('dtp-calendar-cell-active');
    });

    it('should decrement year on left arrow press', () => {
      const calendarBodyEl = multiYearViewElement.querySelector('.dtp-calendar-body');
  ...
  describe('multi-years view with date filter', () => {
    ...
    it('should disable filtered years', () => {
      ...
      expect(cell2019.classList).not.toContain('dtp-calendar-cell-disabled');
      expect(cell2018.classList).toContain('dtp-calendar-cell-disabled');
    });
  });
});
