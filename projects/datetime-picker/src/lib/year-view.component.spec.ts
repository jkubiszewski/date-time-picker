...
describe('YearViewComponent', () => {
  ...
  describe('standard year view', () => {
    ...
    beforeEach(() => {
      ...
      yearViewDebugElement = fixture.debugElement.query(By.directive(YearViewComponent));
    ...
    it('should have 12 months', () => {
      const cellEls = yearViewElement.querySelectorAll('.dtp-calendar-cell')!;
    ...
    it('should show selected month if in same year', () => {
      const selectedElContent = yearViewElement.querySelector(
        '.dtp-calendar-cell-selected.dtp-calendar-cell-content'
      )!;
    ...
    it('should NOT show selected month if in different year', () => {
      ...
      const selectedElContent = yearViewElement.querySelector(
        '.calendar-body-selected.dtp-calendar-cell-content'
      );
    ...
    it('should fire change event on cell clicked', () => {
      ...
      const selectedElContent = yearViewElement.querySelector(
        '.dtp-calendar-cell-active .dtp-calendar-cell-content'
      )!;
    ...
    it('should mark active date', () => {
      ...
      expect(cellDecember.classList).toContain('dtp-calendar-cell-active');
    });
    ...
    it('should decrement month on left arrow press', () => {
      const calendarBodyEl = yearViewElement.querySelector('.dtp-calendar-body');
  ...
  describe('year view with date filter', () => {
    ...
    it('should disable filtered months', () => {
      ...
      expect(cellJan.classList).not.toContain('dtp-calendar-cell-disabled');
      expect(cellFeb.classList).toContain('dtp-calendar-cell-disabled');
    });
  });
});
